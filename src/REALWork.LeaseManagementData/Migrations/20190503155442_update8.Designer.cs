...
namespace REALWork.LeaseManagementData.Migrations
{
    ...
    [Migration("20190503155442_update8")]
            ...
            modelBuilder.Entity("REALWork.LeaseManagementCore.Entities.WorkOrder", b =>
                {
                    ...
                    b.OwnsOne("REALWork.LeaseManagementCore.ValueObjects.Invoice", "Invoice", b1 =>
                        {
                            b1.Property<int>("WorkOrderId");

                            b1.Property<decimal>("InvoiceAmount");

                            b1.Property<DateTime>("InvoiceDate");

                            b1.Property<string>("InvoiceDocUrl");
                            ...
                            b1.HasOne("REALWork.LeaseManagementCore.Entities.WorkOrder", "WorkOrder")
                                .WithOne("Invoice")
                                .HasForeignKey("REALWork.LeaseManagementCore.ValueObjects.Invoice", "WorkOrderId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
