...
{
    public class MasterBedroom : ValueObject
    {
        ...
        private MasterBedroom()
        {
        }

        public MasterBedroom(ConditionType wallAndTrimeB, ConditionType wallAndTrimeE, string wallAndTrimsCommentB, 
