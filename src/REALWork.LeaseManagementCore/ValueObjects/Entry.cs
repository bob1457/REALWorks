...
namespace REALWork.LeaseManagementCore.ValueObjects
{
    public class Entry : ValueObject
    {
        ...
        public Entry(ConditionType wallAndTrimeB, ConditionType wallAndTrimeE, string wallAndTrimsCommentB, string wallAndTrimsCommentE, 
            ...
            string floorCarpetCommentE, string notes)
        {
